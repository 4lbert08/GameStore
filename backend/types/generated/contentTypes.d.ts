...
export interface ApiGameGame extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    gameCover: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    pegi: Schema.Attribute.Enumeration<
...
export interface ApiPegiPegi extends Struct.CollectionTypeSchema {
  collectionName: 'pegis';
  info: {
    description: '';
    displayName: 'Pegi';
    pluralName: 'pegis';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::pegi.pegi'> &
      Schema.Attribute.Private;
    Pegi: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 18;
          min: 3;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    region: Schema.Attribute.Enumeration<['EU', 'NA', 'LATAM', 'AFR', 'ASIA']>;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    role: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.role'
